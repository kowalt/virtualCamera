...
public class VirtualScene {
    ...
    public static ArrayList<Wall> createScene() {
        ...
        scene.add(new Wall(A1, B1, D1, C1, Color.YELLOW, figureHeight));
        scene.add(new Wall(E1, F1, H1, G1, Color.YELLOW, figureHeight));
        scene.add(new Wall(B1, F1, H1, D1, Color.YELLOW, figureHeight));
        scene.add(new Wall(A1, E1, G1, C1, Color.YELLOW, figureHeight));
        scene.add(new Wall(A1, B1, F1, E1, Color.YELLOW, figureHeight));
        scene.add(new Wall(C1, D1, H1, G1, Color.YELLOW, figureHeight));
        ...
        scene.add(new Wall(A3, B3, D3, C3, Color.BLACK, figureHeight));
        scene.add(new Wall(E3, F3, H3, G3, Color.BLACK, figureHeight));
        scene.add(new Wall(B3, F3, H3, D3, Color.BLACK, figureHeight));
        scene.add(new Wall(A3, E3, G3, C3, Color.BLACK, figureHeight));
        scene.add(new Wall(A3, B3, F3, E3, Color.BLACK, figureHeight));
        scene.add(new Wall(C3, D3, H3, G3, Color.BLACK, figureHeight));
        ...
        scene.add(new Wall(A4, B4, D4, C4, Color.RED, figureHeight));
        scene.add(new Wall(E4, F4, H4, G4, Color.RED, figureHeight));
        scene.add(new Wall(B4, F4, H4, D4, Color.RED, figureHeight));
        scene.add(new Wall(A4, E4, G4, C4, Color.RED, figureHeight));
        scene.add(new Wall(A4, B4, F4, E4, Color.RED, figureHeight));
        scene.add(new Wall(C4, D4, H4, G4, Color.RED, figureHeight));
